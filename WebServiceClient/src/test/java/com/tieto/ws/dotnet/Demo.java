...
public class Demo
{
  ...
  public static void main(String args[]) throws AxisFault
  {
    ...
    OMElement result = sender.sendReceive(buildParam("getWeatherbyCityNamePro", new String[] { "theCityName",
        "theUserID" }, new String[] { "杭州", "01" }));
  ...
  public static ProxyProperties buildProxy()
  {
    ...
    proxyProperties.setProxyName("10.32.235.41");
